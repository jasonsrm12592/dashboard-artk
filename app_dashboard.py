...
with tab_kpis:
    if not df_main.empty:
        ...
        # GRÁFICO 1: DESEMPEÑO ACTUAL VS META
        with col_g1:
            st.subheader(f"🎯 Desempeño {anio_sel} vs Meta")
        ...
        # GRÁFICO 2: COMPARATIVO YOY (SIN META)
        with col_g2:
        ...
        # --- NUEVO GRÁFICO: VENTAS POR LÍNEA DE NEGOCIO ---
        c_linea, c_vend = st.columns([1, 1])
