...
# --- NUEVO: GRÁFICO VENTAS SEMANA ACTUAL ---
        ...
        with c_top:
            ...
            st.plotly_chart(ui.config_plotly(go.Figure(go.Bar(x=r_fin.sort_values('Venta_Neta').tail(10)['Venta_Neta'], y=r_fin.sort_values('Venta_Neta').tail(10)['Vendedor'], orientation='h', text=r_fin.sort_values('Venta_Neta').tail(10)['T'], textposition='auto', marker_color='#2ecc71'))), use_container_width=True)
